...
if not os.path.exists("results/clustered_features.csv"):
    print("Erreur : Le fichier 'results/clustered_features.csv' est introuvable. Veuillez exécuter 'clustering.py' d'abord.")
    sys.exit(1)
